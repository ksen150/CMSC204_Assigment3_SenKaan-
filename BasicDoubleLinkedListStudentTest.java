...
public class BasicDoubleLinkedListStudentTest {
	...
	public Car a=new Car("BMW", "528i", 2016);
	public Car b=new Car("BMW", "340i", 2018);
	public Car c=new Car("Honda", "Accord", 2012);
	public Car d=new Car("Audi", "A4", 2020);
	public Car e=new Car("Mercedes", "AMG", 2019);
	public Car f=new Car("Volkswagen", "Jetta", 2015);
